...
export class ADXL100zFFTClient {
    ...
    _onShutdownRequested() {
        ...
        return new Promise((t) => {
            ...
            setTimeout(function e() {
                r._createCommandPromise('CRE', '0000').then(() => {
                    t()
                }).catch(() => {
    ...
    _onFftReady() {
        var n = this;
        this.commandMode = !1, this.fftHeaderInProgress = !0, this.fftHeader = null, this.bus.emit('connected'), this.debug('[_onFftReady] OK'), this.bus.on('fft', (e) => {
            for (; 0 < e.length;) {
        ...
        return new Promise((n) => {
            setTimeout(function t() {
                o.port = new _serialport2.default(o.serialport, {
                    ...
                    o.debug('[error] ' + e.stack), o.closed && o.port.close(() => {
                    ...
                    }, 100), o.port.write('\r'), o.bus.once('command-response', (e) => {
    ...
    shutdown() {
        ...
        return (this.commandMode ? Promise.resolve() : new Promise((e) => {
            r.debug('Schedule the shutdown command...'), r.bus.once('data', () => {
                return e()
            })
        })).then(() => {
            return new Promise((e, t) => {
                return r._onShutdownRequested().then(() => {
    ...
    format(e, t, r, n) {
        ...
        switch (n) {
            ...
            case 'chartWithoutPeak':
                ...
                break;
            case 'all':
                var s = e.raw ? Array.prototype.slice.call(e.raw, 0).map((e) => {
                    return o._convertAmp(e)
                }) : null;
                a.payload = {
                    peaks: i.map((e) => {
